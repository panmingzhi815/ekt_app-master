 ...
 * [dodola/MetaballLoading](https://github.com/dodola/MetaballLoading)
 */
public class MetaBallView extends View {

    public final static String T_View_TAG = "AAAAAA#MVMVMV";
...
//    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        setMeasuredDimension(resolveSizeAndState((int) (ITEM_COUNT * (radius * 2 + ITEM_DIVIDER)) + ITEM_DIVIDER, widthMeasureSpec, 0),
    ...
    protected void onVisibilityChanged(View changedView, int visibility) {
        ...
        if (visibility == GONE || visibility == INVISIBLE) {
            Timber.d(T_View_TAG + "|stopAnimation...");
            stopAnimation();
        } else {
            Timber.d(T_View_TAG + "|startAnimation...");
            startAnimation();
        }
    }
