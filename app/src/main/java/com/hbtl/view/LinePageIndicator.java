...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public boolean setCountOffset(int offset) {
        countOffset = offset;
        return true;
    }
    //# <+++
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final int count = mViewPager.getAdapter().getCount() + countOffset;
        if (count == 0) {
            return;
        }
    ...
    public boolean onTouchEvent(android.view.MotionEvent ev) {
        ...
        if ((mViewPager == null) || (mViewPager.getAdapter().getCount() + countOffset == 0)) {
            return false;
        }
