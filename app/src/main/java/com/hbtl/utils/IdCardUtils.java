...
public class IdCardUtils {
    ...
    private static String[] _areaSerial = {"11", "12", "13", "14", "15", "21",
            "22", "23", "31", "32", "33", "34", "35", "36", "37", "41", "42",
            "43", "44", "45", "46", "50", "51", "52", "53", "54", "61", "62",
            "63", "64", "65", "71", "81", "82", "91"};
    private static HashMap<String, Integer> dateMap;
    private static HashMap<String, String> areaSerialMap;
    ...
    static {
        ...
        dateMap.put("11", 30);
        dateMap.put("12", 31);
        areaSerialMap = new HashMap<String, String>();
        for (String code : _areaSerial) {
            areaSerialMap.put(code, null);
        }
    }
    ...
    public boolean verifyAreaCode(String code) {
        String areaSerial = code.substring(0, 2);
        // Element child= _areaSerialElement.getChild("_"+areaSerial);
        if (areaSerialMap.containsKey(areaSerial)) {
            return true;
        } else {
            _codeError = "错误:输入的身份证号的地区码(1-2位)[" + areaSerial
