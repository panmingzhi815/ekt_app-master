...
//    private HashMap<String, String> translitChars;
    ...
    public LocaleController() {
        ...
        is24HourFormat = DateFormat.is24HourFormat(CoamApplicationLoader.appContextInstance);
        LocaleInfo currentInfo = null;
        boolean override = false;

        try {
            SharedPreferences preferences = CoamApplicationLoader.appContextInstance.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE);
...
//            CoamApplicationLoader.appContextInstance.registerReceiver(new TimeZoneChangedReceiver(), timezoneFilter);
//        } catch (Exception e) {
//            Timber.e("tmessages" + e);
//        }
    }
    ...
    private void saveOtherLanguages() {
        SharedPreferences preferences = CoamApplicationLoader.appContextInstance.getSharedPreferences("langconfig", Activity.MODE_PRIVATE);
...
//    }
    ...
    public void applyLanguage(LocaleInfo localeInfo, boolean override, boolean fromFile) {
        ...
        try {
            ...
            if (newLocale != null) {
                ...
                CoamApplicationLoader.appContextInstance.getResources().updateConfiguration(config, CoamApplicationLoader.appContextInstance.getResources().getDisplayMetrics());
    ...
    private String getStringInternal(String key, int res) {
        ...
        if (value == null) {
            value = CoamApplicationLoader.appContextInstance.getString(res);
        }
        if (value == null) {
            value = "LOC_ERR:" + key;
        }
    ...
    public static String formatPluralString(String key, int plural) {
        ...
        param = key + "_" + param;
        int resourceId = CoamApplicationLoader.appContextInstance.getResources().getIdentifier(param, "string", CoamApplicationLoader.appContextInstance.getPackageName());
...
//    public static String formatUserStatus(CommonAccountInfo user) {
//        return getString("Online", R.string.Online)+"~!..";
////        if (user != null && user.status != null && user.status.expires == 0) {
////            if (user.status instanceof CoamTLRPC.TL_userStatusRecently) {
////                user.status.expires = -100;
////            } else if (user.status instanceof CoamTLRPC.TL_userStatusLastWeek) {
////                user.status.expires = -101;
////            } else if (user.status instanceof CoamTLRPC.TL_userStatusLastMonth) {
////                user.status.expires = -102;
////            }
////        }
////        if (user != null && user.status != null && user.status.expires <= 0) {
//////            if (TelegramMessagesController.getInstance().onlinePrivacy.containsKey(user.id)) {
//////                return getString("Online", R.string.Online);
//////            }
////        }
////        if (user == null || user.status == null || user.status.expires == 0 || UserObject.isDeleted(user) || user instanceof CoamTLRPC.TL_userEmpty) {
////            return getString("ALongTimeAgo", R.string.ALongTimeAgo);
////        } else {
////            int currentTime = 0;//ConnectionsManager.getInstance().getCurrentTime();
...
//            translitChars = new HashMap<String, String>(520);
