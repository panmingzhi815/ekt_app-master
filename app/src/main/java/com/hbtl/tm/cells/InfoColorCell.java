...
public class InfoColorCell extends FrameLayout {
    ...
    public InfoColorCell(Context context) {
        this(context, null);
    }

    public InfoColorCell(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public InfoColorCell(Context context, AttributeSet attrs, int defStyleAttr) {
