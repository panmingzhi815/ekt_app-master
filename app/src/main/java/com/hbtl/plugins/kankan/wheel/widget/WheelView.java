...
package com.hbtl.plugins.kankan.wheel.widget;
...
import com.hbtl.plugins.kankan.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.area_line_border));
        // 设置线宽
